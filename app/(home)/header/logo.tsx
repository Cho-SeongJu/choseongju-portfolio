    ...
    >
      <h1 className={`${step !== "intro" && "mx-auto"} intro-animation`}>
        <span
          className={`${
            step === "intro"
              ? "xl:text-[110px] lg:text-[80px] md:text-[60px] sm:text-[45px] xs:text-[26px]"
        ...
        <span
          className={`${
            step === "intro"
              ? "text-stroke-intro mt-[30px] xl:text-[200px] lg:text-[150px] md:text-[110px] sm:text-[70px] xs:text-[40px]"
